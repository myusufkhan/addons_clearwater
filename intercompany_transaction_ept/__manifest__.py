{
    # App information
    'name': 'Inter Location Transfer and Warehouse Transfer',
    'version': '13.0.1.0',
    'category': 'Operations/Inventory',
    'license': 'OPL-1',
    'summary' : 'Manages Inter Location and Inter Warehouse Transfer.',
    'description':"""
        Module to manage Inter Location Transfer and Inter Warehouse Transfer along with all required documents with easiest way by just simple configurations.
        """,
